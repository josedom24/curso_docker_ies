...
Puedes encontrar el fichero `docker-compose.yml` en en este [directorio](https://github.com/josedom24/curso_doocker_ies/tree/main/ejemplos/sesion4/ejemplo1) del repositorio. 
